...
$photoPath = $photo ? "/DriveUs/Image_Profil/" . htmlspecialchars($photo) : "/DriveUs/Image/default.png";
?>
        ...
        <li>
            ...
            <?php else: ?>
                ...
                <ul id="menu" hidden>
                    ...
                    <li><a href="/DriveUs/Mes_reservations.php"><button>Mes réservations</button></a></li>
                    <li><a href="/DriveUs/Mes_reservations_recues.php"><button>Réservations reçues</button></a></li>
                    <li><a href="/DriveUs/Outils/Mes_trajets.php"><button>Mes trajets</button></a></li>
                    <li><a href="/DriveUs/Outils/Se_deconnecter.php"><button>Se déconnecter</button></a></li>
                </ul>
            <?php endif; ?>
        </li>
        <li>
