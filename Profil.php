...
<body>
        ...
        <div class="content">
            ...
            <div id="form5" class="form-section">
                <div class="info-box">
                    ...
                    <a href="Outils/reservations/Mes_reservations.php">Voir mes reservations</a>
                </div>
                <div class="info-box">
    ...
    <script>
        ...
        function loadVehicles() {
            fetch('Outils/handlers/vehicle_handler.php?action=get_vehicles')
        ...
        function addVehicle() {
            ...
            fetch('Outils/handlers/vehicle_handler.php', {
                method: 'POST',
                body: formData
            })
            .then(response => response.json())
        ...
        function viewVehicleSpec(vehicleId, specFile) {
            window.open('Outils/Permis/vehicles/' + specFile, '_blank');
        }
        ...
        function loadCards() {
            fetch('Outils/handlers/payment_handler.php?action=get_cards')
                .then(response => response.json())
                .then(data => {
        ...
        function addCard() {
            ...
            fetch('Outils/handlers/payment_handler.php', {
                method: 'POST',
                body: formData
            })
            .then(response => response.json())
